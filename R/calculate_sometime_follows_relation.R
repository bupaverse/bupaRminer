calculate_sometime_follows_relation <- function(
  ...
  print(glue::glue("Som fol 1: {SOMETIMES_FOL_1}"))
  print(glue::glue("Som fol 2: {SOMETIMES_FOL_2}"))
  print(glue::glue("Som fol 3: {SOMETIMES_FOL_3}"))



  SOMETIMES_FOL_ab <- SOMETIMES_FOL_1 * (1 - abs(SOMETIMES_FOL_2 - SOMETIMES_FOL_3))
  print(glue::glue("Som fol ab: {SOMETIMES_FOL_ab}"))
  ...
  print(glue::glue("Som fol ba: {SOMETIMES_FOL_ba}"))
